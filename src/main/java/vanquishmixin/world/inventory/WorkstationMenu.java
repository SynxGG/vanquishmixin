...
public class WorkstationMenu extends AbstractContainerMenu implements VanquishmixinModMenus.MenuAccessor {
	...
	public WorkstationMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VanquishmixinModMenus.WORKSTATION.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 26, 17) {
			...
			private int x = WorkstationMenu.this.x;
			private int y = WorkstationMenu.this.y;
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 26, 55) {
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 26, 36) {
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 44, 36) {
		...
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 44, 55) {
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 62, 36) {
		...
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 62, 55) {
