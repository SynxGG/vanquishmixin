...
@Mod("vanquishmixin")
public class VanquishmixinMod {
	public static final Logger LOGGER = LogManager.getLogger(VanquishmixinMod.class);
	public static final String MODID = "vanquishmixin";

	public VanquishmixinMod(FMLJavaModLoadingContext context) {
